...
const STATIC_ROUTES = [
  ...
  '/about',
  '/services',
  // per-service SEO landing pages (+ architecture sub-pages)
  '/services/arqiteqturuli-momsakhureba',
  '/services/kerdzo-sakhlis-proeqtireba',
  '/services/korpusis-proeqtireba',
  '/services/1-klasis-shenobis-proeqtireba',
  '/services/konstruqciuli-momsakhureba',
