...
const faqs = [
  ...
  {
    q: "როგორ ფორმდება თანამშრომლობა — არის თუ არა ხელშეკრულება?",
    a: "თანამშრომლობა ყოველთვის ხდება ხელშეკრულების დეტალურად გადახედვითა და გაფორმებით. ხელშეკრულებაში ნათლად იწერება სამუშაოს მოცულობა, ეტაპები, ვადები, ფასი და მხარეთა ვალდებულებები — ყველა სამართლებრივი ნორმისა და წესის დაცვით. ასე თქვენ დაცული ხართ მოულოდნელი ხარჯებისა და გაუგებრობებისგან, ჩვენ კი გამჭვირვალედ და პასუხისმგებლობით ვმუშაობთ.",
  },
]
