...
export const featured = [
  {
    ...
    metaDescription:
      "სრული არქიტექტურული მომსახურება — კერძო სახლის, კორპუსის და 1 კლასის შენობის პროექტირება. ასიმეტრია არქიტექტურული კომპანია საქართველოში.",
    intro:
  ...
  },
  {
    ...
    metaDescription:
      "კონსტრუქციული პროექტი, დასკვნა და ექსპერტიზა — შენობის სიმტკიცისა და უსაფრთხოების გარანტია. ასიმეტრია არქიტექტურული კომპანია.",
    intro:
